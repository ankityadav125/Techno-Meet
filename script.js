...
gsap.to(
  ".home .main .text h1, .home .main .text p, .home .main .text .button, .home .main .text .box",
  {
    y: 0,
    opacity: 1,
    duration: 1,
...
animateElements(".summary .text h2, .summary .text p, .summary .container", {
  trigger: ".summary",
}); 

animateElements(".summary .grid .box", {
...
animateElements(
  ".recording .text .heading, .recording .text p, .recording .text .button, .recording .rec",
  { trigger: ".recording" }
);

animateElements(".footer .text, .footer .link", {
  trigger: ".footer",
  stagger: 0.8,
});
